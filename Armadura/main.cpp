...
la cantidad de datos que se quieren almacenar, debe agregarse una función que migre los datos ya ordenados (en bloques de grupo)
a una única lista enlazada, donde estarán todas lar armaduras.

La aplicación además, requiere de un método de búsqueda, que permite obtener la armadura buscando por su índice de las listas.
...
public:
    ...
    Armadura extraer() {
        Armadura aux = almacen[num_elementos-1];
        num_elementos--;
        return aux;
    }
...
int main() {
    ...
    cout << "Contenedor 1" << endl; c1->mostrar();
    cout << endl;
    cout << "Contenedor 2" << endl; c2->mostrar();
    cout << endl;
    cout << "Contenedor 3" << endl; c3->mostrar();
    cout << endl;
