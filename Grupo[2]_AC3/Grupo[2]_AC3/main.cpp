...
int main(){
    ...
    do{ cout<<"--------------------------------------------"<<endl;
        ...
        cout<<"--------------------------------------------"<<endl;
        cout<<"Opcion 1-Mostrar catalogo"<<endl;
        cout<<"Opcion 2-Buscar por album"<<endl;
        cout<<"Opcion 3-Buscar por grupo"<< endl;
        cout<<"Opcion 4-Buscar por genero"<< endl;
        cout<<"Opcion 5-Salir"<<endl;
        cout<<"--------------------------------------------"<<endl;
        cin>>choose;
        switch (choose){
            case 1:
                cout<<"Entrando en la opcion 1(Muestra el catalogo):"<<endl;
                mostrarCatalogo();
                break;
            case 2:
                cout<<"Entrando en la opcion 2(Buscar por album):"<<endl;
                BuscarAlbum();
                break;
            case 3:
                cout<<"Entrando en la opcion 3(Buscar por grupo):"<<endl;
                BuscarGrupoMusical();
                break;
            case 4:
                cout<<"Entrando en la opcion 4(Buscar por genero):"<<endl;
                BuscarGeneroMusical();
                break;
